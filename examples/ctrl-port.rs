...
fn main() -> Result<()> {
    ...
    info!("Block Call (GET): curl http://127.0.0.1:1337/api/fg/0/block/0/call/myhandler/");
    info!(
        r#"Block Call (POST): curl -X POST -H "Content-Type: application/json" -d '{{ "U32": 123 }}'  http://127.0.0.1:1337/api/fg/0/block/0/call/myhandler/"#
    );
