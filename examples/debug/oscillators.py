...
class oscillators(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "oscillators")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/basti/src/futuresdr/examples/debug/sig-source.f32', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, 4800, 1, 0, 0)
        ...
        self.connect((self.blocks_throttle_0_0, 0), (self.blocks_sub_xx_0, 1))
...
def main(top_block_cls=oscillators, options=None):
