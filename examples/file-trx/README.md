...
To broadcast a previously recorded file, plug in your SDR and run this command:
```sh
...
- To record a signal from a specific frequency to a file, plug in your SDR and run this command:
```sh
