...
where
    ...
    NullSource<i32, B::Writer<i32>>: SendKernel,
    Head<i32, ReaderOf<B, i32>, B::Writer<i32>>: SendKernel,
    Add<ReaderOf<B, i32>, B::Writer<i32>>: SendKernel,
    NullSink<i32, ReaderOf<B, i32>>: SendKernel,
{
